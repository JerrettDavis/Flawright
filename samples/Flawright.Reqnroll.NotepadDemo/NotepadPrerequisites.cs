...
namespace Flawright.Reqnroll.NotepadDemo;

/// <summary>
/// Reqnroll hook that skips each Notepad scenario when <c>notepad.exe</c> does not
...
/// </remarks>
[Binding]
internal static class NotepadPrerequisites
{
    /// <summary>
