...
internal static class KeyParser
{
    ...
    internal static VirtualKeyShort ParseKey(string name)
    {
        return name.ToUpperInvariant() switch
        {
            ...
            "SHIFT" or "LEFTSHIFT" or "SHIFTKEY" => VirtualKeyShort.LSHIFT,
            "RIGHTSHIFT" => VirtualKeyShort.RSHIFT,
            "CTRL" or "CONTROL" or "LEFTCTRL" or "LEFTCONTROL" => VirtualKeyShort.LCONTROL,
            "RIGHTCTRL" or "RIGHTCONTROL" => VirtualKeyShort.RCONTROL,
            "ALT" or "LEFTALT" => VirtualKeyShort.ALT,
            "RIGHTALT" => VirtualKeyShort.RMENU,
